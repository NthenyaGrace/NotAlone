...
<form id="questionForm">
    <div id="question" class="test">
      <div class="question1">
        <div id="questionText">
          <label for="q1">1).&nbsp;&nbsp; Do you feel 'stressful' when people touch you?</label>
        </div>
        <div id="options">
          <select id="q1">
    ...
    <div id="question" class="test">
      <div class="question2">
        <div id="questionText">
          <label for="q2">2).&nbsp;&nbsp; Do you avoid people, places & situations because you fear what may happen?</label>
        </div>
        <div id="options">
          <select id="q2">
            <option value="0">Never</option>
    ...
    <div id="question" class="test">
      <div class="question4">
        <div id="questionText">
          <label for="q4">4).&nbsp;&nbsp; Do you feel saffocated in a certain situation/relationship?</label>
        </div>
        <div id="options">
          <select id="q4">
            <option value="0">Never</option>
    ...
    <div id="question" class="test">
      <div class="question5">
        <div id="questionText">
          <label for="q5">5).&nbsp;&nbsp; Do you get physically abused?</label>
        </div>
        <div id="options">
          <select id="q5">
            <option value="0">Never</option>
    ...
    <div id="question" class="test">
      <div class="question6">
        <div id="questionText">
          <label for="q6">6).&nbsp;&nbsp; I get nervous and/or edgy around people because of unforeseeable events</label>
        </div>
        <div id="options">
          <select id="q6">
            <option value="0">Never</option>
