...
$statement = $connect->prepare($query);
        $statement->execute();
echo '<script>alert("Thank You..! Your Feedback is Valuable to Us"); location.replace(index_doctor.php);</script>';
}
?>
<!DOCTYPE html>
<html>
<head>
<title>Not Alone | Complaints</title>
<!-- custom-theme -->
