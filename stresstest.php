...
<html>
	<head>
		<title>Not Alone | Substance Abuse and Addiction</title>
  <meta charset="utf-8">
...
<div class="collapse navbar-collapse navbar-right navbar-main-collapse">
 ...
 <div class="container">
    <form id="healthSurvey">
      ...
      <div class="form-group">
        <p><b>2)</b>&nbsp;&nbsp;In the past year, have you experienced any of the following symptoms when you stop using?</p>
        ...
        <input type="checkbox" name="symptoms" value="option3" id="box8"><label for="box8">Vomiting.</label><br>
        <input type="checkbox" name="symptoms" value="option4" id="box9"><label for="box9">Feverish.</label><br>
      ...
      <div class="form-group">
        ...
        <input type="checkbox" name="stressRelievers" value="option2" id="box12"><label for="box12">Taking Supplements</label><br>
        <input type="checkbox" name="stressRelievers" value="option3" id="box13"><label for="box13">Reducing drug intake.</label><br>
        <input type="checkbox" name="stressRelievers" value="option4" id="box14"><label for="box14">Spending time with friends and family.</label><br><br>
      </div>
       <div class="form-group">
        ...
        <div class="form-group">
        <p>  <b>5)</b>&nbsp;&nbsp; How often do you find yourself using a lot of money on drugs? </p>
