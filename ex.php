...
<div class="collapse navbar-collapse navbar-right navbar-main-collapse">
 ...
 <section class="docs">
  ...
  <div class="rev_box1">
               ...
               <img style="width: 220px; height: 220px;" src="img/doctors/d1.jpg">
                </div>
                <div class="rev_cntnt">
                <p class="rev_title">Dr. Jamuna Ruth</p>
  ...
  <div class="rev_box1">
                ...
                <img style="width: 220px; height: 220px;" src="img/doctors/d3.png">
                </div>
                <div class="rev_cntnt">
                <p class="rev_title">Counsellor Rose</p>
  ...
  <div class="rev_box1">
                ...
                <img style="width: 220px; height: 220px;" src="img/doctors/d4.jpg">
                </div>
                <div class="rev_cntnt">
                <p class="rev_title">Counsellor Paul</p>
                <p class="rev_cap">(Masters in Counselling Psychology)</p>
                 <p class="rev_cap">(Counsellor)</p>
             </div>
                 <div class="btn_s_bottom">
                </a><a href="anxietydoc3.php">
                    <button class="butn" style="margin-top:20px; background: #3FBBC0;color: #fff;border-radius: 30px;font-size: 16px; padding: 10px;">More About Him</button>
                  </a>
                </div>
              </div>
  </div>  
